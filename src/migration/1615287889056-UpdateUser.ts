...
export class UpdateUser1615287889056 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `password` char(200) NOT NULL, `email` char(50) NULL, `postId` int NULL, `googleId` char(50) NULL, `loginGoogle` tinyint NOT NULL, `userpostsId` int NULL, UNIQUE INDEX `IDX_638bac731294171648258260ff` (`password`), UNIQUE INDEX `REL_4d79edb29ed31870be0b1c32d5` (`userpostsId`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    )
    await queryRunner.query(
