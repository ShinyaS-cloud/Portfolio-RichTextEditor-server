...
export class Login1615374506569 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `post` (`id` int NOT NULL AUTO_INCREMENT, `title` char(100) NOT NULL, `imageUrl` char(100) NULL, `category` int NOT NULL, `userId` int NULL, UNIQUE INDEX `REL_5c1cf55c308037b5aca1038a13` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `favorites` (`id` int NOT NULL AUTO_INCREMENT, `userId` int NOT NULL, `postId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `user` ADD UNIQUE INDEX `IDX_3394a5669cfb3c85cea4b368fc` (`postId`)");
        ...
        await queryRunner.query("CREATE UNIQUE INDEX `REL_3394a5669cfb3c85cea4b368fc` ON `user` (`postId`)");
        ...
        await queryRunner.query("ALTER TABLE `user` ADD CONSTRAINT `FK_3394a5669cfb3c85cea4b368fca` FOREIGN KEY (`postId`) REFERENCES `post`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE UNIQUE INDEX `REL_4d79edb29ed31870be0b1c32d5` ON `user` (`userpostsId`)");
